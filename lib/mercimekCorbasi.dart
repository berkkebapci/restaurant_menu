                                   ...
                                   Column(
                                    children: [
                                      Padding(
                                        ...
                                        child: Text("Mercimek Çorbası",style: TextStyle(fontSize: 35,color: Colors.white,fontWeight: FontWeight.bold),),
                                      ),
                                    ],
                                  ),
                              ],
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Center(
                                              child: Text("Sıcacık Nefis Mercimek Çorbası, Limon, Acı Biber ve Ekmek Servisiyle..",
