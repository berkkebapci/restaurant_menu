                                ...
                                Column(
                                  children: [
                                    Padding(
                                      ...
                                      child: Text("Latte",style: TextStyle(fontSize: 35,color: Colors.white,fontWeight: FontWeight.bold),),
                                    ),
                                  ],
                                ),
                              ],
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            Text("12 ₺",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.blue,fontSize: 22),),
                                          ],
                                        ),
                                        Padding(
                                        ...
                                        Padding(
                                          ...
                                          child: Text("Ne İçeceğinize Karar Veremediyseniz ..",
