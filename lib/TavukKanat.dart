...
class TavukKanat extends StatelessWidget {
                          ...
                          child: DecoratedBox(
                                ...
                                Column(
                                  children: [
                                    Padding(
                                      ...
                                      child: Text("Tavuk Kanat",style: TextStyle(fontSize: 35,color: Colors.white,fontWeight: FontWeight.bold),),
                                    ),
                                  ],
                                ),
                              ],
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                  image: AssetImage("tavukKanat.jpg"),
                                  fit: BoxFit.cover,
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            Text("27.00 ₺",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.blue,fontSize: 22),),
                                          ],
                                        ),
                                        Padding(
                                        ...
                                        Padding(
                                          ...
                                          child: Text("200 gr Tavuk Kanat (Bulgur Pilavı ve Biber ile Servis Edilir)",
