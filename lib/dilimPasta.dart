...
class DilimPasta extends StatelessWidget {
                                ...
                                Column(
                                  children: [
                                    Padding(
                                      ...
                                      child: Text("Dilim Pasta",style: TextStyle(fontSize: 35,color: Colors.white,fontWeight: FontWeight.bold),),
                                    ),
                                  ],
                                ),
                              ],
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            Text("15 ₺",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.blue,fontSize: 22),),
                                          ],
                                        ),
                                        Padding(
                                        ...
                                        Padding(
                                          ...
                                          child: Text("Taptaze Çikolatalı ve Krokanlı Pasta",
