                                ...
                                Column(
                                  children: [
                                    Padding(
                                      ...
                                      child: Text("Cheese Burger",style: TextStyle(fontSize: 35,color: Colors.white,fontWeight: FontWeight.bold),),
                                    ),
                                  ],
                                ),
                              ],
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            Text("22.00 ₺",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.blue,fontSize: 22),),
                                          ],
                                        ),
                                        Padding(
                                        ...
                                        Padding(
                                          ...
                                          child: Text("100 gr Hamburger Eti (İçinde Turşu, peynir, Marul ve Ketçap ile)",
