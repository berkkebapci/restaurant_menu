...
class CilekliMilkshake extends StatelessWidget {
                                ...
                                Column(
                                  children: [
                                    Padding(
                                      ...
                                      child: Text("Çilekli Milkshake",style: TextStyle(fontSize: 35,color: Colors.white,fontWeight: FontWeight.bold),),
                                    ),
                                  ],
                                ),
                              ],
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Text("Çok Lezzetli Çilekli Milkshake",
