                                ...
                                Column(
                                  children: [
                                    Padding(
                                      ...
                                      child: Text("Adana Kebap",style: TextStyle(fontSize: 35,color: Colors.white,fontWeight: FontWeight.bold),),
                                    ),
                                  ],
                                ),
                              ],
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Text("250 gr Adana Kebabı ( Közlenmiş Domates, Közlenmiş Biber, Salata, Pilav ile beraber servis edilir.)",
