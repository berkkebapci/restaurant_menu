...
class SmokeHouseBurger extends StatelessWidget {
                                ...
                                Column(
                                  children: [
                                    Padding(
                                      ...
                                      child: Text("Smoke House Burger",style: TextStyle(fontSize: 35,color: Colors.white,fontWeight: FontWeight.bold),),
                                    ),
                                  ],
                                ),
                              ],
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            Text("35.00 ₺",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.blue,fontSize: 22),),
                                          ],
                                        ),
                                        Padding(
                                        ...
                                        Padding(
                                          ...
                                          child: Text("120 gr Hamburger Eti, Füme Eti, Cheddar Peyniri, Turşu, Çıtır Kaplamalı Soğan Parçaları ve Barbekü Sosu ile)",
