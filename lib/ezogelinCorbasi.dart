                                ...
                                Column(
                                  children: [
                                    Padding(
                                      ...
                                      child: Text("Ezogelin Çorbası",style: TextStyle(fontSize: 35,color: Colors.white,fontWeight: FontWeight.bold),),
                                    ),
                                  ],
                                ),
                              ],
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Text("Sıcacık Nefis Ezogelin Çorbası, Limon, Acı Biber ve Ekmek Servisiyle..",
