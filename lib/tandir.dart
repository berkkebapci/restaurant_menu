...
class Tandir extends StatelessWidget {
                                ...
                                Column(
                                  children: [
                                    Padding(
                                      ...
                                      child: Text("Tandır Kebap",style: TextStyle(fontSize: 35,color: Colors.white,fontWeight: FontWeight.bold),),
                                    ),
                                  ],
                                ),
                              ],
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Text("300 gr Tandır Kebabı ( Pide, Domates, Biber ve Pilav ile beraber servis edilir.)",
