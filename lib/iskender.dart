...
class Iskender extends StatelessWidget {
                                ...
                                Column(
                                  children: [
                                    Padding(
                                      ...
                                      child: Text("Iskender Kebap",style: TextStyle(fontSize: 35,color: Colors.white,fontWeight: FontWeight.bold),),
                                    ),
                                  ],
                                ),
                              ],
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Text("300 gr İskender Kebabı ( Közlenmiş Domates, Közlenmiş Biber ve Tereyağı ile beraber servis edilir.)",
